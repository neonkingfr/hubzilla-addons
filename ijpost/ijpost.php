...
function ijpost_jot_nets(&$a,&$b) {
	...
	if((! local_channel()) || (! perm_is_allowed(local_channel(),'','view_stream',false)))
        ...
        $b .= '<div class="profile-jot-net"><input type="checkbox" name="ijpost_enable" ' . $selected . ' value="1" /> <i class="fa fa-meh-o fa-lg" aria-hidden="true"></i> ' . t('Post to Insane Journal') . '</div>';
}
