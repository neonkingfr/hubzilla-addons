...
function wppost_jot_nets(&$b) {
	...
	if($wp_post) {
		...
		$b .= '<div class="profile-jot-net"><input type="checkbox" name="wppost_enable" ' . $selected . ' value="1" /> <i class="fa fa-wordpress fa-lg" aria-hidden="true"></i> ' . t('Post to WordPress') . '</div>';
	}
}
