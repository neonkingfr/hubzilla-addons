var logger = function() {
	...
	pub.log = function log(message) {var now = new Date();
		var now = new Date();
...
//				if(this.content.boxPublicID == 0) {
//					this.content.boxPublicID = new Date().getTime();
//					logger.log('box.save(): Attached a public ID to this box. It was not set yet.');
//				}
